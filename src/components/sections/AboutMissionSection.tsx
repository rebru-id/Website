...
export default function AboutMissionSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative py-[var(--section-py)] px-12"
      ...
      >
        ...
        <div
          className="absolute top-[-2rem] left-1/2 -translate-x-1/2 font-display text-[16rem] leading-none pointer-events-none select-none"
          style={{ color: "rgba(122,171,126,0.05)" }}
          aria-hidden="true"
        >
          &ldquo;
        </div>
        ...
        <div className="relative z-10 max-w-[820px] mx-auto text-center">
          <p
            className="font-mono text-[0.7rem] tracking-[0.25em] uppercase mb-8"
            style={{ color: "var(--forest-sage)" }}
          >
            About Rebru
          </p>
          <h2
            className="font-display font-semibold leading-[1.12] mb-8"
            style={{
          ...
          <p
            className="text-[1.05rem] leading-[1.9] mb-6"
            style={{ color: "var(--cta-text-sub)" }}
          >
            At Rebru, we specialize in transforming spent coffee grounds into
            high-value climate products and regenerative materials. Based in{" "}
            <strong style={{ color: "var(--cta-text)" }}>
          ...
          <p
            ...
            style={{ color: "var(--cta-text-sub)", opacity: 0.8 }}
          >
            Our core expertise lies in collecting, processing, and upgrading
            spent coffee grounds into impactful products — from biochar that
            locks carbon for centuries, to compost that heals soil, to
            bio-briquettes that displace fossil fuels.
          </p>
        </div>

        <div
          className="absolute bottom-0 left-0 right-0 h-px"
          style={{ background: "var(--cta-top-line)", opacity: 0.3 }}
        />
      </div>
      ...
      <div
        ref={ref}
        className="relative z-10 max-w-[1280px] mx-auto px-12 py-24"
      >
        {/* Ambient glow */}
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 50% at 50% 50%, var(--about-values-glow) 0%, transparent 70%)",
          }}
        />

        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-7">
          {PILLARS.map(
            ({ tag, icon, title, body, accent, bg, border, tagBg }, i) => (
              <div
                key={tag}
                ...
                style={{
                  ...
                  transitionDelay: `${160 + i * 200}ms`,
                }}
              >
                <div className="flex items-center justify-between mb-8">
                  <span
                    className="font-mono text-[0.65rem] tracking-[0.18em] uppercase px-3 py-1 rounded-pill"
                  ...
                  >
                    <i
                      className={`fas ${icon} text-[0.85rem]`}
                      style={{ color: accent }}
                    />
                  </div>
                </div>
                ...
                <h3
                  className="font-display font-semibold text-[1.55rem] leading-[1.25] mb-5"
                ...
                <p
                  className="text-[0.92rem] leading-[1.85]"
