// src/components/sections/AboutProcessSection.tsx
"use client";
      ...
      <div ref={ref} className="relative z-10 max-w-[1280px] mx-auto">
        ...
        <div className="mb-20">
          ...
          <div className="flex items-end justify-between flex-wrap gap-6">
            <h2
              className={`section-title max-w-[480px] transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
            ...
            >
              ...
              strategic entry point for circular economy innovation in
              Indonesia.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-7 mb-16">
          {REASONS.map(
            ({ number, icon, title, body, accent, bg, border }, i) => (
              <div
                key={number}
              ...
              >
                ...
                <div className="flex items-center justify-between mb-8">
                  ...
                  >
                    <i
                      className={`fas ${icon} text-[0.92rem]`}
                      style={{ color: accent }}
                    />
                  </div>
                </div>
                ...
                <h3
                  className="font-display font-semibold text-[1.5rem] leading-tight mb-5"
                ...
                <p
                  className="text-[0.9rem] leading-[1.85] mt-auto"
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center gap-8">
            <div className="flex-1">
              ...
              <h4
                className="font-display font-semibold text-[1.3rem] mb-2"
                style={{ color: "var(--text-primary)" }}
              >
              ...
              <p
                ...
                style={{ color: "var(--text-secondary)" }}
              >
                To support composting and biochar production at scale, we
                integrate other high-volume agricultural organic waste streams
                alongside coffee grounds.
              </p>
            </div>
            {/* Tags */}
