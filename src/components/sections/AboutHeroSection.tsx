...
function OrbitsGraphic() {
  ...
  return (
    <div className="relative w-full h-full min-h-[420px] flex items-center justify-center">
      <div
        className="absolute w-[380px] h-[380px] rounded-full animate-ring-float"
        style={{
      ...
      <div
        ...
        style={{
          border: "1px solid var(--ring-inner-1)",
      ...
      <div
        ...
        style={{
          border: "1px solid var(--ring-inner-2)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(74,44,26,0.55) 0%, rgba(45,90,46,0.25) 100%)",
          border: "1px solid var(--border-strong)",
          boxShadow: "0 0 48px var(--about-orbit-glow)",
        }}
      >
        <i
          className="fas fa-coffee text-[1.5rem]"
      ...
      {nodes.map(({ angle, icon, label, color }) => {
        ...
        return (
          <div
            ...
            style={{
              transform: `translate(${Math.cos(rad) * 140}px, ${Math.sin(rad) * 140}px)`,
            }}
          >
            <div
            ...
            <span
              className="font-mono text-[0.58rem] tracking-[0.12em] uppercase whitespace-nowrap"
...
export default function AboutHeroSection() {
  ...
  return (
    <section
      className="relative min-h-screen flex items-center pt-[var(--section-py-lg)] pb-[var(--section-py)] px-12 overflow-hidden"
      style={{ background: "var(--about-hero-gradient)" }}
    >
      {/* Grid texture */}
      <div
      ...
      >
        ...
        <div>
          ...
          <p
            className={`text-[1rem] leading-[1.9] max-w-[460px] mb-12 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          ...
          {/* Stats row */}
          <div
            className={`grid grid-cols-2 sm:grid-cols-4 gap-px transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
            style={{
        ...
        {/* Right */}
        <div
          className={`hidden lg:flex items-center justify-center transition-all duration-1000 ${inView ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}
